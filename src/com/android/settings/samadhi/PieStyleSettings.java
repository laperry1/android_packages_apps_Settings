...
package com.android.settings.samadhi;
...
import android.preference.SamadhiSeekBarPreference;
...
public class PieStyleSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPieBackgroundAlpha = (SamadhiSeekBarPreference) findPreference(PREF_PIE_BACKGROUND_ALPHA);
        ...
        mPieControlSize = (SamadhiSeekBarPreference) findPreference(PREF_PIE_CONTROL_SIZE);
