...
public class PieButtonStyleSettings extends SettingsPreferenceFragment implements
    ...
    SamadhiSeekBarPreference mPieButtonAlpha;
    SamadhiSeekBarPreference mPieButtonPressedAlpha;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPieButtonAlpha =
                (SamadhiSeekBarPreference) findPreference(PREF_PIE_BUTTON_ALPHA);
        mPieButtonAlpha.setOnPreferenceChangeListener(this);

        mPieButtonPressedAlpha =
                (SamadhiSeekBarPreference) findPreference(PREF_PIE_BUTTON_PRESSED_ALPHA);
